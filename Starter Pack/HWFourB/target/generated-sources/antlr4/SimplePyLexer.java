...
public class SimplePyLexer extends Lexer {
	...
	public static final String[] ruleNames = {
		"T__2", "T__1", "T__0", "ID", "INT", "LPAREN", "RPAREN", "LBRACK", "RBRACK", 
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		switch (ruleIndex) {
		case 5: LPAREN_action((RuleContext)_localctx, actionIndex); break;
		case 6: RPAREN_action((RuleContext)_localctx, actionIndex); break;
		case 7: LBRACK_action((RuleContext)_localctx, actionIndex); break;
		case 8: RBRACK_action((RuleContext)_localctx, actionIndex); break;
		}
	}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 9: return IGNORE_NEWLINE_sempred((RuleContext)_localctx, predIndex);
		}
		return true;
	}
