...
public class FuzzyJavaParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'static'", "'int'", "'final'", "'public'", "Identifier", 
		"CharacterLiteral", "StringLiteral", "COMMENT", "WS", "LINE_COMMENT", 
		"OTHER"
	};
	public static final int
	...
	public final AltfileContext altfile() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__3) | (1L << T__2) | (1L << T__1) | (1L << T__0) | (1L << Identifier) | (1L << CharacterLiteral) | (1L << StringLiteral) | (1L << COMMENT) | (1L << WS) | (1L << LINE_COMMENT) | (1L << OTHER))) != 0)) {
				{
				setState(25);
	...
	public final ConstantContext constant() throws RecognitionException {
		...
		try {
			...
			setState(34); ((ConstantContext)_localctx).Identifier = match(Identifier);
	...
	public static final String _serializedATN =
		...
		"\3\2\2\2\35\33\3\2\2\2\35\36\3\2\2\2\36\5\3\2\2\2\37\35\3\2\2\2 !\7\6"+
		"\2\2!\"\7\3\2\2\"#\7\5\2\2#$\7\4\2\2$%\7\7\2\2%&\b\4\1\2&\7\3\2\2\2\7"+
		"\13\22\27\33\35";
