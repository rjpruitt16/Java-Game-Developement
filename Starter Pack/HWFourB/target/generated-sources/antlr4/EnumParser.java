...
public class EnumParser extends Parser {
	...
	public static final int
		T__5=1, T__4=2, T__3=3, T__2=4, T__1=5, T__0=6, ID=7, INT=8, WS=9;
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(16); ((StatContext)_localctx).id = id();
			setState(17); match(T__0);
			setState(18); ((StatContext)_localctx).expr = expr();
	...
	public final EnumDeclContext enumDecl() throws RecognitionException {
		...
		try {
			...
			setState(28); ((EnumDeclContext)_localctx).name = id();
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 3: return enumDecl_sempred((EnumDeclContext)_localctx, predIndex);
		case 4: return id_sempred((IdContext)_localctx, predIndex);
		}
		return true;
	}
